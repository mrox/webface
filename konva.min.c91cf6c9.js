...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"konva.min.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
  ...
  var h = Math.PI / 180,
    ...
    _prepareToStringify: function (t) {
      ...
      for (var i in t.visitedByCircularReferenceRemoval = !0, t) if (t.hasOwnProperty(i) && t[i] && "object" == typeof t[i]) if (e = Object.getOwnPropertyDescriptor(t, i), t[i].visitedByCircularReferenceRemoval || L._isElement(t[i])) {
  ...
  var M,
      G = (P(R, M = T), R.prototype._fillColor = function (t) {
    var e = t.fill();
  ...
  var I,
      E,
      D = (P(F, I = T), F.prototype._fill = function (t) {
  ...
  var K = {},
    ...
    for (i = 0; i < h; i++) if (o = (r = s[i].split("."))[0], a = r[1], o) this.eventListeners[o] && this._off(o, a, e);else for (n in this.eventListeners) this._off(n, a, e);
    ...
    for (e = 0; e < r; e++) if (i = n[e], L.isValidSelector(i) || (L.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), L.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), L.warn("Konva is awesome, right?")), "#" === i.charAt(0)) {
    ...
    var e,
        ...
        r,
        o,
        a = L.cloneObject(this.attrs);

    for (e in t) a[e] = t[e];

    var s = new this.constructor(a);

    for (e in this.eventListeners) for (n = (i = this.eventListeners[e]).length, r = 0; r < n; r++) (o = i[r]).name.indexOf("konva") < 0 && (s.eventListeners[e] || (s.eventListeners[e] = []), s.eventListeners[e].push(o));
    ...
    for (n = 0; n < a.length; n++) if (r = a[n].name, o = a[n].handler, !("konva" === r && "konva" !== e || e && r !== e || i && i !== o)) {
    ...
    var i,
        n,
        r,
        o = ct.prototype.getClassName.call(t),
        a = t.children;
    if (e && (t.attrs.container = e), s[o] || (L.warn('Can not find a node with class name "' + o + '". Fallback to "Shape".'), o = "Shape"), i = new s[o](t.attrs), a) for (n = a.length, r = 0; r < n; r++) i.add(ct._createNode(a[r]));
    return i;
  }, ct);
  ...
  var pt,
      ut = (P(ft, pt = dt), ft.prototype.getChildren = function (e) {
    ...
    for (var l = this.find("Shape"), d = !1, c = 0; c < l.length; c++) if (l[c]._isVisible(this)) {
      d = !0;
      break;
    }
  ...
  var Xt,
      jt = (P(Ut, Xt = ut), Ut.prototype._validateAdd = function (t) {
    ...
    if (O.isBrowser) for (var t = 0; t < Nt; t++) Wt(this, zt[t]);
  ...
  var qt,
      Vt = (P(Kt, qt = ut), Kt.prototype.createPNGStream = function () {
  ...
  var le,
      de = (P(ce, le = dt), ce.prototype.getContext = function () {
    ...
    if (h.save(), this._useBufferCanvas(i) && !n) {
      if ((o = (r = this.getStage().bufferCanvas).getContext()).clear(), o.save(), o._applyLineJoin(this), !i) if (a) a._applyTransform(this, o, e);else {
    ...
    if (!a) return this;
    if (o.save(), o._applyLineJoin(this), !i) if (n) n._applyTransform(this, o, e);else {
  ...
  var ye,
      me = (P(_e, ye = Vt), _e.prototype._validateAdd = function (t) {
  ...
  var Se,
      be = (P(xe, Se = ut), xe.prototype._validateAdd = function (t) {
    var e = t.getType();
  ...
  var we = n.performance && n.performance.now ? function () {
    ...
    for (n = 0; n < l.length; n++) if (e = (t = l[n]).layers, i = t.func, t._updateFrameObject(we()), o = e.length, !i || !1 !== i.call(t, t.frame)) for (r = 0; r < o; r++) void 0 !== (a = e[r])._id && (h[a._id] = a);
  ...
  var Re = (Oe.prototype._addAttr = function (t, e) {
    ...
    if ((r = Oe.tweens[c][t]) && delete Oe.attrs[c][r][t], i = d.getAttr(t), L._isArray(e)) {
      if (n = [], a = Math.max(e.length, i.length), "points" === t && e.length !== i.length && (e.length > i.length ? (h = i, i = L._prepareArrayForTween(i, e, d.closed())) : (s = e, e = L._prepareArrayForTween(e, i, d.closed()))), 0 === t.indexOf("fill")) {
        for (o = 0; o < a; o++) if (o % 2 == 0) n.push(e[o] - i[o]);else {
    ...
    for (e in d) {
      if (n = (i = d[e]).start, r = i.diff, h = i.end, L._isArray(n)) {
        if (o = [], s = Math.max(n.length, h.length), 0 === e.indexOf("fill")) for (a = 0; a < s; a++) a % 2 == 0 ? o.push((n[a] || 0) + r[a] * t) : o.push("rgba(" + Math.round(n[a].r + r[a].r * t) + "," + Math.round(n[a].g + r[a].g * t) + "," + Math.round(n[a].b + r[a].b * t) + "," + (n[a].a + r[a].a * t) + ")");else for (a = 0; a < s; a++) o.push((n[a] || 0) + r[a] * t);
  ...
  var Be,
      ze = (P(Ne, Be = de), Ne.prototype._sceneFunc = function (t) {
    var e,
        i,
        n,
        r = this.points(),
    ...
    if (o) {
      ...
      } else if (h) for (n = 2; n < o;) t.bezierCurveTo(r[n++], r[n++], r[n++], r[n++], r[n++], r[n++]);else for (n = 2; n < o; n += 2) t.lineTo(r[n], r[n + 1]);
  ...
  var We,
      He = (P(Ye, We = ze), Ye.prototype._sceneFunc = function (t) {
  ...
  var Xe,
      je = (P(Ue, Xe = de), Ue.prototype._sceneFunc = function (t) {
  ...
  var qe,
      Ve = (P(Ke, qe = de), Ke.prototype._sceneFunc = function (t) {
    var e = this.radiusX(),
        i = this.radiusY();
  ...
  var Qe,
      Je = (P(Ze, Qe = de), Ze.prototype._useBufferCanvas = function () {
  ...
  var $e,
      ti = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width"],
      ei = "right",
      ii = "down",
      ni = "left",
      ri = ti.length,
  ...
  var si,
      hi = (P(li, si = de), li.prototype._sceneFunc = function (t) {
    var e = this.width(),
        i = this.height(),
  ...
  var di,
      ci = (P(pi, di = de), pi.prototype._sceneFunc = function (t) {
    ...
    this.dataArray.forEach(function (t) {
      if ("A" === t.command) {
        var e = t.points[4],
            ...
            n = t.points[4] + i,
            r = Math.PI / 180;
        if (Math.abs(e - n) < r && (r = Math.abs(e - n)), i < 0) for (var o = e - r; n < o; o -= r) {
          var a = pi.getPointOnEllipticalArc(t.points[0], t.points[1], t.points[2], t.points[3], o, 0);
          s.push(a.x, a.y);
        } else for (o = e + r; o < n; o += r) a = pi.getPointOnEllipticalArc(t.points[0], t.points[1], t.points[2], t.points[3], o, 0), s.push(a.x, a.y);
      } else if ("C" === t.command) for (o = 0; o <= 1; o += .01) a = pi.getPointOnCubicBezier(o, t.start.x, t.start.y, t.points[0], t.points[1], t.points[2], t.points[3], t.points[4], t.points[5]), s.push(a.x, a.y);else s = s.concat(t.points);
    });
      ...
      for (; 0 < u.length && !isNaN(u[0]);) {
        ...
        switch (p) {
          ...
          case "m":
            var R = u.shift(),
                O = u.shift();
            if (h += R, l += O, T = "M", 2 < a.length && "z" === a[a.length - 1].command) for (var L = a.length - 2; 0 <= L; L--) if ("M" === a[L].command) {
    ...
    switch (i) {
      ...
      case "A":
        ...
        var l = n[4],
            ...
            c = n[4] + d,
            p = Math.PI / 180;
        if (Math.abs(l - c) < p && (p = Math.abs(l - c)), o = h.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], l, 0), d < 0) for (s = l - p; c < s; s -= p) a = h.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], s, 0), r += h.getLineLength(o.x, o.y, a.x, a.y), o = a;else for (s = l + p; s < c; s += p) a = h.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], s, 0), r += h.getLineLength(o.x, o.y, a.x, a.y), o = a;
  ...
  var ui,
      fi = (P(gi, ui = de), gi.prototype._sceneFunc = function (t) {
  ...
  var vi,
      yi = (P(mi, vi = de), mi.prototype._sceneFunc = function (t) {
    var e,
        i,
        n,
        r = this.sides(),
  ...
  var wi,
      Ci = (P(Pi, wi = de), Pi.prototype._sceneFunc = function (t) {
    var e = this.animation(),
        ...
        l = r[3 + n],
        d = this.image();
    if ((this.hasFill() || this.hasStroke()) && (t.beginPath(), t.rect(0, 0, h, l), t.closePath(), t.fillStrokeShape(this)), d) if (o) {
      var c = o[e],
          p = 2 * i;
  ...
  var ki,
      Ti = (P(Ai, ki = de), Ai.prototype._sceneFunc = function (t) {
  ...
  var Ei,
      Di = (P(Fi, Ei = de), Fi.prototype._sceneFunc = function (t) {
    var e,
        i = this.padding(),
        n = this.fontSize(),
        r = this.lineHeight() * n,
  ...
  var Ni,
      Wi = (P(Hi, Ni = de), Hi.prototype._sceneFunc = function (t) {
  ...
  var Ki,
      Qi = ["top-left", "top-center", "top-right", "middle-right", "middle-left", "bottom-left", "bottom-center", "bottom-right"],
    ...
    var e,
        i,
        n,
        r = this.findOne("." + this._movingAnchorName),
        o = r.getStage();
    ...
    } else if ("top-center" === this._movingAnchorName) this.findOne(".top-left").y(r.y());else if ("top-right" === this._movingAnchorName) {
  ...
  var $i,
      tn = (P(en, $i = de), en.prototype._sceneFunc = function (t) {
    ...
    Filters: {
      ...
      Kaleidoscope: function (t) {
        ...
        if (!(p < 1)) {
          ...
          !function (t, e, i) {
            ...
            for (_ = 0; _ < w; _ += 1) for (S = Math.sin(_ * C), b = Math.cos(_ * C), m = 0; m < x; m += 1) r = Math.floor(c + y * m / x * b), u = s[(n = 4 * ((o = Math.floor(p + y * m / x * S)) * l + r)) + 0], f = s[n + 1], g = s[n + 2], v = s[n + 3], h[(n = 4 * (_ + m * l)) + 0] = u, h[n + 1] = f, h[n + 2] = g, h[n + 3] = v;
          }(t, v, {
            polarCenterX: d / 2,
            polarCenterY: c / 2
          });
          ...
          for (d < f + y && (_ = m, S = 0, b = -1), i = 0; i < c; i += 1) for (e = _; e !== S; e += b) h = 4 * (d * i + Math.round(e + f) % d), r = v.data[h + 0], o = v.data[h + 1], a = v.data[h + 2], s = v.data[h + 3], l = 4 * (d * i + e), v.data[l + 0] = r, v.data[l + 1] = o, v.data[l + 2] = a, v.data[l + 3] = s;

          for (i = 0; i < c; i += 1) for (m = Math.floor(y), n = 0; n < p; n += 1) {
          ...
          !function (t, e, i) {
            ...
            for (r = 0; r < c; r += 1) for (o = 0; o < p; o += 1) a = r - u, s = o - f, S = Math.sqrt(a * a + s * s) * w / _, b = (b = (180 * Math.atan2(s, a) / Math.PI + 360 + P) % 360) * C / 360, x = Math.floor(b), g = l[(n = 4 * (Math.floor(S) * c + x)) + 0], v = l[n + 1], y = l[n + 2], m = l[n + 3], d[(n = 4 * (o * c + r)) + 0] = g, d[n + 1] = v, d[n + 2] = y, d[n + 3] = m;
          }(v, t, {
            polarRotation: 0
          });
        }
      ...
      Mask: function (t) {
        ...
        return e && function (t, e) {
          ...
          for (var n = [1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9], r = Math.round(Math.sqrt(n.length)), o = Math.floor(r / 2), a = [], s = 0; s < i; s++) for (var h = 0; h < e; h++) {
            for (var l = s * e + h, d = 0, c = 0; c < r; c++) for (var p = 0; p < r; p++) {
              var u = s + c - o,
                  f = h + p - o;
          ...
          for (var n = [1, 1, 1, 1, 1, 1, 1, 1, 1], r = Math.round(Math.sqrt(n.length)), o = Math.floor(r / 2), a = [], s = 0; s < i; s++) for (var h = 0; h < e; h++) {
            for (var l = s * e + h, d = 0, c = 0; c < r; c++) for (var p = 0; p < r; p++) {
              var u = s + c - o,
                  f = h + p - o;
          ...
          for (var n = [1, 1, 1, 1, 0, 1, 1, 1, 1], r = Math.round(Math.sqrt(n.length)), o = Math.floor(r / 2), a = [], s = 0; s < i; s++) for (var h = 0; h < e; h++) {
            for (var l = s * e + h, d = 0, c = 0; c < r; c++) for (var p = 0; p < r; p++) {
              var u = s + c - o,
                  f = h + p - o;
      ...
      Pixelate: function (t) {
        ...
        if (g <= 0) L.error("pixelSize value can not be <= 0");else for (p = 0; p < m; p += 1) for (u = 0; u < _; u += 1) {
          for (l = (h = p * g) + g, c = (d = u * g) + g, f = s = a = o = r = 0, e = h; e < l; e += 1) if (!(v <= e)) for (i = d; i < c; i += 1) y <= i || (r += S[(n = 4 * (v * i + e)) + 0], o += S[n + 1], a += S[n + 2], s += S[n + 3], f += 1);

          for (r /= f, o /= f, a /= f, s /= f, e = h; e < l; e += 1) if (!(v <= e)) for (i = d; i < c; i += 1) y <= i || (S[(n = 4 * (v * i + e)) + 0] = r, S[n + 1] = o, S[n + 2] = a, S[n + 3] = s);
        }
      },
...
//# sourceMappingURL=/konva.min.c91cf6c9.map