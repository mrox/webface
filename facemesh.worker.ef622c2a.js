...
},{"@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js","buffer":"node_modules/buffer/index.js"}],"node_modules/@tensorflow-models/facemesh/dist/facemesh.esm.js":[function(require,module,exports) {
"use strict";
...
const FACEMESH_GRAPHMODEL_PATH = "./facemesh",
...
},{"@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js","@tensorflow/tfjs-converter":"node_modules/@tensorflow/tfjs-converter/dist/tf-converter.esm.js"}],"facemesh.worker.js":[function(require,module,exports) {
"use strict";

var facemesh = _interopRequireWildcard(require("@tensorflow-models/facemesh"));
...
self.onmessage = async e => {
  ...
  if (!isRunning && !loading) {
    ...
    imageData = new ImageData(imageData, e.data.width, e.data.height); // let imageData = e.data
    ...
    if (predictions.length > 0) {
      ...
      for (let i = 0; i < pointsData.length; i++) {
        flattenedPointsData = flattenedPointsData.concat(pointsData[i]); // console.log(pointsData[i]);
      }
    ...
    isRunning = false;
    var t1 = performance.now(); // console.log("Call to face took " + (t1 - t0) + " milliseconds.")
  }
};
},{"@tensorflow-models/facemesh":"node_modules/@tensorflow-models/facemesh/dist/facemesh.esm.js","@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js"}]},{},["facemesh.worker.js"], "window")
//# sourceMappingURL=/facemesh.worker.ef622c2a.map