...
},{"./_FullInternals":"node_modules/konva/lib/_FullInternals.js"}],"draw.js":[function(require,module,exports) {
"use strict";
...
class FaceIDUI {
  ...
  init() {
    ...
    var staticLayer = new _konva.default.Layer();

    for (let i = 0; i < 360 / this.split; i++) {
      this.rotate = i * this.split;
      let arc2 = new _konva.default.Arc({
        x: stage.width() / 2,
        y: stage.height() / 2,
        innerRadius: inner,
        outerRadius: outer,
      ...
      let arc0 = new _konva.default.Arc({
        x: stage.width() / 2,
        y: stage.height() / 2,
        innerRadius: inner,
      ...
      let anim = new _konva.default.Animation(function (frame) {
        let amplitude = 1.3;
...
exports.default = FaceIDUI;
},{"konva":"node_modules/konva/lib/index.js"}],"new.js":[function(require,module,exports) {
"use strict";
...
let draws = [];
let step = 8;
let faceIdUI = new _draw.default({
  step
});
faceIdUI.init();
let resetBtn = document.getElementById('reset');
const faceMeshWorker = new Worker("/facemesh.worker.b0440b9e.js");
...
(async () => {
  ...
  document.body.appendChild(stats.dom); // model = await facemesh.load({ maxFaces: 1 });
...
},{"stats.js":"node_modules/stats.js/build/stats.min.js","./draw":"draw.js","./worker/facemesh.worker.js":[["facemesh.worker.b0440b9e.js","worker/facemesh.worker.js"],"facemesh.worker.b0440b9e.map","worker/facemesh.worker.js"]}]},{},["new.js"], "window")
//# sourceMappingURL=/new.0ac14a2a.map